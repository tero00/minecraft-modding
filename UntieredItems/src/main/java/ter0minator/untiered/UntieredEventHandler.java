...
public class UntieredEventHandler {	
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
    	...
    	reg.register(new Weapon(UNTIERED, "marohi_mace", 1.5, 9.666));
    	reg.register(new Weapon(UNTIERED, "embrace_axe", 1.5, 9.666));
    	reg.register(new Weapon(UNTIERED, "bright_mace", 0.418, 1));
    	reg.register(new Weapon(UNTIERED, "divinity_sword", 1, 5.333));
    	reg.register(CRONUS);
    }
